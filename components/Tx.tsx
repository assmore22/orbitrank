...
import { writeMethod, waitAccepted, busyMessage, hasContract } from "@/lib/orbitrank";
  ...
  return (
    <ToastCtx.Provider value={{ push, update }}>
      ...
      <div className="pointer-events-none fixed bottom-4 right-4 z-[60] flex w-[min(92vw,360px)] flex-col gap-2">
        {toasts.map((t) => (
          <div key={t.id} className="panel pointer-events-auto flex items-start gap-3 p-3 text-sm shadow-pop animate-fadeUp">
            <FontAwesomeIcon
